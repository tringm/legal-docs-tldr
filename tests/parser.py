...
from .results import TestResultCompareFileMeld, TestResultLogMetrics
...
class TestParser(argparse.ArgumentParser):
    ...
    def __init__(self):
        ...
        self.add_argument(
            ...
            type=str,
            default=".logs",
            help="Path to log dir containing debug log (default: .logs)",
        )
        self.add_argument("-s", "--logStdout", action="store_true", help="log to stdout as well as to a log file")
        self.add_argument("-q", "--quiet", action="store_true", help="Set logging level as INFO (default: False)")
        ...
        suite_parser.add_argument("suiteName", type=str, help="Name of the suite to be run")
        case_parser = sub_parser.add_parser("case", help="Run a test case or method")
        case_parser.add_argument(
            "caseName", type=str, help="Path to TestCase or method from the testDir separated by dot"
        )
    ...
    def __call__(self):
        ...
        log_config_kwargs = {
            ...
            "handlers": [file_handler, logging.StreamHandler()] if args.logStdout else [file_handler],
        }
