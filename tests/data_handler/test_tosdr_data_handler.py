from data_handler.tosdr import TosdrDataLoader, service_quote_text_and_summary, service_urls
...
class TestTosdrDataLoader(CompareTestCase):
    ...
    def force_reload_step(self):
        ...
        self.loader.load_service_data_in_file(self.services_input_folder / "github.json", force_reload=True)
