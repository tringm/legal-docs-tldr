...
def default_logging_config(logging_level: str = "INFO", log_to_file: Path = None, file_logging_level: str = "DEBUG"):
    ...
    config_dict = {
        ...
        "loggers": {"": {"handlers": list(handlers_config.keys()), "level": "DEBUG"}},
    }
